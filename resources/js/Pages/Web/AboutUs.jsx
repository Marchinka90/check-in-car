    ...
    <>
      <Section id='about-us' className='bg-background-light py-16'>
        <div className="container">
          <div className="flex items-center sm:flex-col	lg:flex-row lg:justify-between">
          <h1 className="lg:hidden text-primary text-center font-montserrat mb-5 text-3xl py-2 ">Кои сме ние</h1>
            <div className="text-center w-2/5 sm:w-3/4">
              <Image src="./img/about-us.webp" alt="about-us" width="450" preview />
            </div>
            <div className="w-5/6 flex flex-col items-center lg:w-3/5">
              <h1 className="text-primary  text-center font-montserrat mb-10 sm:hidden lg:block lg:py-14 lg:text-4xl">Кои сме ние</h1>
              <p className="text-primary font-lato text-justify text-lg tracking-wide leading-relaxed mb-3 lg:mr-8 lg:text-xl">Ние сме екип от отдадени професионалисти, ангажирани да гарантират безопасността и надеждността на вашите превозни средства. Със страст към съвършенството в автомобилите, нашите сертифицирани техници са специализирани в провеждането на задълбочени годишни прегледи на широк набор от автомобилни превозни средства. Нашата мисия е да предоставим ефективни и прозрачни услуги, които ви дават възможност да шофирате с увереност. Доверете ни се за всичките си нужди от проверка на превозни средства и усетете разликата в екипа, който поставя вашата безопасност на първо място.</p>
              <ScrollLink
                to='reservation'
                smooth={true}
                duration={1000}
