...
export default function Services() {
  const products = [
    ...
    },
    {
      ...
      icon: 'local_shipping',
      description: 'Поддържайте безпроблемната работа на вашия камион с нашата годишна инспекция. Извършване на подробна проверка на критичните компоненти, за да се гарантира безопасност и надеждност. Получете изчерпателен отчет за вашето спокойствие на пътя. Планирайте годишната техническа проверка на вашия товарен автомобил до 3.5 тона днес за надеждна работа през цялата година.',
