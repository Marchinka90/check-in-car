    ...
    <>
      <Section id='contacts' className='bg-white py-32'>
        <div className='bg-background-light'>
          ...
          <div className="lg:container lg:relative ">
            <Card className='lg:absolute w-full lg:bottom-12 lg:left-12 lg:w-[36%] flex justify-center flex-wrap'>
              <div className="text-primary text-center w-min-[15rem] mx-2 sm:w-full flex justify-between flex-wrap tracking-wide leading-relaxed">
        ...
        <div className="container pt-10 pb-5 bg-background-light lg:bg-white lg:pt-0">
          <h1 className="text-primary text-center font-montserrat text-2xl sm:text-3xl mt-10 lg:py-14 lg:text-4xl lg:mt-20">Пишете ни</h1>
          <ContactsForm />
        </div>
      </Section>
      <style>{`
